...
# Azure Key Vault Creation Script

This script is intended for the **Cyber Security Team** to create an Azure Key Vault, store secrets, and configure access policies.
