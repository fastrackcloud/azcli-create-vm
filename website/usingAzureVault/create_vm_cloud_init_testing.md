# Azure VM Creation and Website Deployment Script

This script is for the DevOps team to create an Azure VM, configure its Managed Identity, and deploy a website using Cloud-Init.
